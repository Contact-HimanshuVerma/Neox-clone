    ...
    <>
      <div className="hover:cursor-pointer">
        ...
        <OurBrandCommon
          ...
          desc2={
            "Retain the audit files in the ADOC tool by paying a yearly maintenance fees per audit file which will allow audit firms to access the stored audit file. Or  will provide the readable version of all the documents in the audit file by paying one-time fee per audit file."
          }
        />
        <OurBrandCommon
          title={
        ...
        <OurBrandCommon
          ...
          desc={" is expecting ADOC to be launched by May 2023."}
        />
        <AdocFaqQ6
          title={
        ...
        <OurBrandCommon
          ...
          desc={
            "  will add users to the audit file in ADOC based on the request sent by the audit firm. Only the users assigned to the respective audit file in the ADOC will have access to the respective engagement file depending on the roles and restrictions assigned. The audit firm can also ask  to provide “view only” rights to the users added to the audit file."
          }
        />
        <OurBrandCommon
          title={"10. Will  have access to the audit file?"}
          desc={
            "The  will not have any access to the audit files. As mentioned earlier, only the users assigned to the respective audit file in the ADOC will have access to the respective engagement file. "
          }
          desc2={
            " will seek prior consent of the Audit Firm to access the metadata in an audit file without identification of the client or the audit engagement in order to develop AI programmes and solutions based on the historical experiences in the audit in such engagements."
          }
        />
        ...
        <OurBrandCommon
          ...
          desc={
            " will have a dedicated support team to help the users navigate through the problems encountered by them on the technical aspect. "
          }
        />
        ...
        <OurBrandCommon
          ...
          desc={
            "No. Users will not be able to transfer the audit files from ADOC to other documentation tools and vice-versa. For transferring the data out of ADOC, will provide support to take the print of the documentation or will extract the files in the form of non-editable PDF/ word / excel and share it with the users."
          }
          desc2={
        ...
        <OurBrandCommon
          ...
          desc2={
            " also intends to share the ADAT tool with the regulators to get their views and feedback to ensure there is no disconnect in terms of procedures to be followed in an audit engagement."
          }
        />
